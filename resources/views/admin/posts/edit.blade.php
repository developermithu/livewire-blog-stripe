            ...
            <x-form action="{{ route('admin.posts.update', $post) }}" method="PUT" has-files>
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <x-form.input id="photo_credit_text" class="block w-full mt-1" type="text" name="photo_credit_text" :value="$post->photo_credit_text"   />
                    ...
                    <div>
                        ...
                        <x-form.input id="photo_credit_link" class="block w-full mt-1" type="text" name="photo_credit_link" :value="$post->photo_credit_link"   />
                    ...
                    <div class="flex justify-between">
                        ...
                        <div>
                            ...
                            <x-pikaday name="published_at" format="YYYY-MM-DD" :value="$post->publishedAt()" class=" rounded-md"/>
